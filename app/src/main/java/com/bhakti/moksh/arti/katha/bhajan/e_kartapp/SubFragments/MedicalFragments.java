...
public class MedicalFragments extends Fragment {
    ...
    public MedicalFragments(String categeryid) {

        this.categeryid = categeryid;
        Log.d(TAG, "MedicalFragments: " + categeryid);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_medical_fragments, container, false);
